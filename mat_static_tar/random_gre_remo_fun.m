function [N_ran_cover, ran_remain_gre_remo, gre_remo_rate_ran] = random_gre_remo_fun(Nr,N_direction,...
    N_failure,tar_cover)
...
%                s_random_index,N_ran_cover); 
 [N_ran_cover, ran_remain_gre_remo, gre_remo_rate_ran]= greedy_removal(Nr, N_failure, tar_cover, ...
               s_random_index);
