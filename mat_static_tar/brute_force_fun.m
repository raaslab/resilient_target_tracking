function [N_bf_cover,bf_remain_best_romo,best_remo_rate_bf] = brute_force_fun(Nr,N_direction,...
    N_failure,tar_cover)
    ...
    N_bf_cover = length(s_tra_cover_bf{Nr+1}); 
    best_remo_rate_bf =(N_bf_cover-bf_remain_best_romo)/N_bf_cover;  
end
