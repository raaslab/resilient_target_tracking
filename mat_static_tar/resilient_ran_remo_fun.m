function [N_resilience_cover, resi_remain_ran_remo, ran_remo_rate_resi] = resilient_ran_remo_fun(Nr,N_direction,...
    N_failure, N_resilience, r_set,tar_cover,N_r_maxtra,tra_r_max_inx, r_ran_remo)
...
%                r_tra_resilience_inx,N_resilience_cover);
           ...
           %random removal. 
           [N_resilience_cover, resi_remain_ran_remo, ran_remo_rate_resi]= random_removal(Nr, tar_cover, ...
               r_tra_resilience_inx, r_ran_remo);
