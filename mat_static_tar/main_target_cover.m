...
h3 = plot(gre);
h4 = plot(ran); 
legend( [h1 h2 h3 h4], 'resilient', 'brute-force','greedy','random');
...
xlabel('trail','fontsize',11)
ylabel('coverage number','fontsize',11)
h1 = plot(resi_remain_bestremo);
h2 = plot(bf_remain_bestremo);
...
xlabel('trail','fontsize',11)
ylabel('coverage number','fontsize',11)
h1 = plot(bestremo_rate_resi);
h2 = plot(bestremo_rate_bf);
