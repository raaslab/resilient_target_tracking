function [N_ran_cover, ran_remain_best_remo, best_remo_rate_ran] = random_ran_remo_fun(Nr,N_direction,...
...
%                s_random_index,N_ran_cover); 
 [N_ran_cover, ran_remain_best_remo, best_remo_rate_ran]= random_removal(Nr, tar_cover, ...
               s_random_index, r_ran_remo);
